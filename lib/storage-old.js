...
// hold multiple types of resources, not specifically bound to a note
...
exports.createItem = function(schemaName, item) {
  ...
  // we expect schemaname (type of data model - cats, notes, etc) to be passed in
...
exports.fetchItem = function(schemaName, id) {
  // go into that object and fetch objects, return back to user
  return new Promise((resolve, reject) => {
    ...
    // notes[id]
    // can also chain storage[schemaName][id] (not sure of accuracy here)
    var item = schema[id];
...
/* WHITEBOARD
  ...
  line 18 - if (!storage[schemaName]) storage[schemaName] = {};
    storage = {
      notes: {}
    }

  line 22 - storage[schemaName][item.id] = item;
    storage = {
      notes: {
        a3cb1dfp: {
          name: 'cool note',
